...
<html>
    <head>
        ...
        <title>Accedi - Basket Room</title>
    </head>
    <body>
        <div id="logo">
            Basket Room
        ...
        <main class="login">
        <section class="main">
            <h5>Per continuare, accedi a Basket Room.</h5>
            <?php
            ...
            <div class="signup-btn-container"><a class="signup-btn" href="signup.php">ISCRIVITI A BASKET ROOM</a></div>
        </section>
        </main>
    </body>
</html>